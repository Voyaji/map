...
const ZoomInButton = ({ onZoomIn }) => {
    return (
        <div onClick={() => onZoomIn()} className="flex w-[80px] h-[80px]">
        ...
        `}</style>
                ...
                <g clip-path="url(#clip0_130_252)" className='bg-yellow-200'>
                    <g filter="url(#filter0_d_130_252)" className='bg-red-700'>
