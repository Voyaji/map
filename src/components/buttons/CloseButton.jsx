...
const CloseButton = ({onClose, className}) => {
  return (
    ...
    <path className="group-hover:stroke-black" d="M23 19L35 31M23 31L35 19L23 31Z" stroke="#B5B5B5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </g>
    <defs>
        <filter id="filter0_d_130_254" x="0" y="0" width="57.9996" height="57.9996" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
